...
class Scoreboard():
    ...
    def prep_high_score(self):
        ''' Turn the hight score into a render image '''
    ...
    def prep_level(self):
        ...
        self.level_image = self.font.render(level,True,self.text_color,self.ai_settings.background_color)
